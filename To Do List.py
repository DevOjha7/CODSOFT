...
my_font = Font(family="Avallon",size=25,weight='bold')

#creating main frame inside main frame have two frame one wil be button frame and another list frame
main_frame=Frame(root,bg='light green')
main_frame.pack()
main_frame.pack_propagate(False)
main_frame.configure(width=790,height=460)

text_label=Label(main_frame,text='Enter Your To Do Things :',font=('Terminal,bold',13),bg='light green')
text_label.place(x=2,y=10)

#list frame
list_frame=Frame(main_frame,bg='light green')
list_frame.place(x=200,y=60,width=590,height=400)

#creating list box
my_list=Listbox(list_frame,font=my_font,width=25,height=7,bg='light green',bd=0,fg='#464646',highlightthickness=0,selectbackground="#a6a6a6",activestyle='none')
...
my_entry=Entry(main_frame,font=('Ragazza',24),width=31,bd=5)
...
#button frame
button_frame=Frame(main_frame,bg='light green')
